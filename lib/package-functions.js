...
const validateMdLinkAsync = (mdLinks) => new Promise((resolve) => {
...
const statsMdLinks = (mdLinksArray) => {
  ...
  if (totalMdLinks > 1) {
    const hrefLinks = mdLinksArray.map((match) => match.href);
...
const validateMdLinkArray = (mdLinksArray) => new Promise((resolve) => {
...
const validateMdLinksArray = (mdLinksArray) => new Promise((resolve) => {
  const validateLinks = mdLinksArray.map(validateMdLinkAsync);
  Promise.all(validateLinks)
